  ...
  return new Promise((resolve, reject) => {
    ...
    api.connect(address)
      .then(async (ftpClient) => {
        ...
        const site = buildFTPAddress({host: url.hostname, user: '', password: '' , port: url.port || 21});
        await dispatch(ftpConnectSuccess(ftpClient, site, url.username, url.password));
...
const ftpConnectSuccess = (ftpClient, address, username, password) => ({
